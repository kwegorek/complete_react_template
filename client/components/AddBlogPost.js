...
let savedpost = {imageUrl: '', title: '', content: '', tag: ''}
...
class AddBlogPost extends React.Component {
  ...
  handleSubmit(evt) {
    ...
    let mapTolowercaseTags = tagArray.map(function (el) {
    ...
    return (
      <React.Fragment>
        ...
        <div className="add-post-container">
          <div className="blog-post-title-add">
            <h1>Add Post</h1>
          </div>
          <div>
            <form className="form-inputs ">
              ...
              <div className="blog-item-add btn-add">
                ...
                <button
                  onClick={(evt) => this.handlePreview(evt)}
                  type="submit"
                >
                  <Link
